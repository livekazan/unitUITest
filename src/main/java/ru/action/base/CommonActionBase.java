...
public abstract class CommonActionBase extends ActionSupport implements SessionAware {

    private static final Logger LOGGER = Logger.getLogger(CommonActionBase.class);
    private Map<String, Object> session;
    private DataService dataService;
    protected String result;
    protected String data;

    public CommonActionBase() {
    }

    public CommonActionBase(DataService dataService) {
