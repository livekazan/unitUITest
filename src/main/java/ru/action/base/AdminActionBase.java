...
public abstract class AdminActionBase extends ActionSupport implements SessionAware {

    private static final Logger LOGGER = Logger.getLogger(AdminActionBase.class);
    private Map<String, Object> session;
    private DataService dataService;
    protected String result;
    protected String data;

    public AdminActionBase() {
    }

    public AdminActionBase(DataService dataService) {
